  ...
  const saveTemplate = async () => {
    ...
    emailEditorRef.current.editor.exportHtml(async (data) => {
      ...
      const newTemplate = {
        ...
        emailName: templateForm.emailName, // ✅ Correctly mapped
        email: templateForm.email,
        category: templateForm.category,
        markup: html, // ✅ Changed content → markup
      };
      ...
      <main className="flex-1 overflow-y-auto p-6 bg-gray-950">
        {activeTab === "list" ? (
          ...
          <div className="bg-gray-900 rounded-lg shadow-md border border-gray-700 p-6">
            <h2 className="text-xl font-semibold text-white mb-6">Create New Template</h2>
            <div className="space-y-6">
              <label className="block text-sm text-gray-400">Template Name</label>
              <input
                name="name"
              ...
              <input
                ...
                onChange={(e) => setTemplateForm({ ...templateForm, emailName: e.target.value })}
                className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white"
              ...
              <label className="block text-sm text-gray-400">Email Editor</label>
